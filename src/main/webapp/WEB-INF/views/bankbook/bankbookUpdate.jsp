...
<div class="container-fluid">
	<form class="col-md-3 mx-auto" action="./bankbookUpdate" method="post">
		...
		<div class="mb-3">
		  ...
		  <input type="text" class="form-control" name="bookRate" value="${dto.bookRate}" id="bookRate" placeholder="0.00">
		</div>
		
	<c:choose>
		<c:when test="${dto.bookSale eq 1}">
			<div class="form-check">
			  <input class="form-check-input" type="radio" name="bookSale" value="1" id="flexRadioDefault1"checked>
